 ...
 */
public interface IView2ModelCtrlAdapter<TDropListItem, TDropListItem1> {
	...
	/**
	 * @param classname
	 * tell the model to add a paint strategy
	 */
	 ...
	 */
	public void makeBall(Component window, TDropListItem selectedItem, TDropListItem1 selectedItem1);
	 ...
	 */
	public void makeSwitchBall(Component window, TDropListItem1 s1);
