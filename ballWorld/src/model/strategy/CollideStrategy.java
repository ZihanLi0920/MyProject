...
public class CollideStrategy<TDispMsg> implements IUpdateStrategy<IBallCmd> {
	 ...
	 * Send a command out to all the other balls to see if anyone has collided with the context ball and to process that collision accordingly.
	 */
	@Override
	public void updateState(Ball ball, IDispatcher<IBallCmd> dispatcher) {
		// TODO Auto-generated method stub
		dispatcher.dispatch((IBallCmd) (context, disp) -> {
